...
#define CapSense_CSD_TOTAL_SENSOR_COUNT            (3u)
#define CapSense_CSD_TOTAL_SCANSLOT_COUNT          (3u)
...
#define CapSense_CSD_PORT_PIN_CONFIG_TBL_ZISE   (3u)
...
#define CapSense_CSD_RESOLUTIONS_TBL_SIZE       (3u)
...
#else
    #define CapSense_CSD_CFG_REG_TBL_SIZE       (8u)
#endif /* (CY_PSOC4_4000) */
...
#define CapSense_CSD_PORT_SEL3_PTR          	( (reg32 *) CYREG_HSIOM_PORT_SEL3 )
...
#if (CapSense_CSD_CFG_REG_TBL_SIZE > 4u)
...
#endif /* (CapSense_CSD_CFG_REG_TBL_SIZE > 4u) */

#if (CapSense_CSD_CFG_REG_TBL_SIZE > 5u)
...
#endif /* (CapSense_CSD_CFG_REG_TBL_SIZE > 5u) */

#if (CapSense_CSD_CFG_REG_TBL_SIZE > 6u)
	...
	#define CapSense_CSD_PORT_SEL7_REG          (*(reg32 *) CYREG_HSIOM_PORT_SEL7 )
	#define CapSense_CSD_PORT_SEL7_PTR          ( (reg32 *) CYREG_HSIOM_PORT_SEL7 )
#endif /* (CapSense_CSD_CFG_REG_TBL_SIZE > 6u) */
    ...
    /* Port DR and PC registers */
	#define CapSense_CSD_PORT7_DR_REG           (*(reg32 *) CYREG_GPIO_PRT7_DR )
	#define CapSense_CSD_PORT7_DR_PTR           ( (reg32 *) CYREG_GPIO_PRT7_DR )

	/* Port DR and PC registers */
	#define CapSense_CSD_PORT7_PC_REG           (*(reg32 *) CYREG_GPIO_PRT7_PC )
	#define CapSense_CSD_PORT7_PC_PTR           ( (reg32 *) CYREG_GPIO_PRT7_PC )
	...
	*******************************************************************************/
		...
		#define CapSense_CSD_CTANK_PORT_DR_REG          (CapSense_CSD_PORT4_DR_REG)
	#else
		#define CapSense_CSD_CMOD_CONNECTION_REG        (CapSense_CSD_PORT_SEL5_REG)
		#define CapSense_CSD_CMOD_PORT_PC_REG           (CapSense_CSD_PORT5_PC_REG)
		#define CapSense_CSD_CMOD_PORT_DR_REG           (CapSense_CSD_PORT5_DR_REG)

		#define CapSense_CSD_CTANK_CONNECTION_REG       (CapSense_CSD_PORT_SEL5_REG)
		#define CapSense_CSD_CTANK_PORT_PC_REG          (CapSense_CSD_PORT5_PC_REG)
		#define CapSense_CSD_CTANK_PORT_DR_REG          (CapSense_CSD_PORT5_DR_REG)
	#endif /* (CapSense_CSD_CSD_FFB__CSD_NUMBER != 1u) */
