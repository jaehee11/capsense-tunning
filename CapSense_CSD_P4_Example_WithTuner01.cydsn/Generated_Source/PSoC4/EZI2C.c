...
static void EZI2C_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void EZI2C_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            EZI2C_SCL_HSIOM_SEL_GPIO,
            EZI2C_SDA_HSIOM_SEL_GPIO,
        ...
        {
        #if (EZI2C_SCL_PIN)
            hsiomSel[EZI2C_SCL_PIN_INDEX] = EZI2C_SCL_HSIOM_SEL_I2C;
            pinsDm  [EZI2C_SCL_PIN_INDEX] = EZI2C_PIN_DM_OD_LO;
        ...
        #if (EZI2C_SDA_PIN)
            hsiomSel[EZI2C_SDA_PIN_INDEX] = EZI2C_SDA_HSIOM_SEL_I2C;
            pinsDm  [EZI2C_SDA_PIN_INDEX] = EZI2C_PIN_DM_OD_LO;
        #endif /* (EZI2C_SDA_PIN) */
        }
    #if (!EZI2C_CY_SCBIP_V1)
        ...
        {
        #if (EZI2C_SCL_PIN)
            hsiomSel[EZI2C_SCL_PIN_INDEX] = EZI2C_SCL_HSIOM_SEL_SPI;
        #elif (EZI2C_RX_WAKE_SDA_MOSI_PIN)
        ...
        #if (EZI2C_SDA_PIN)
            hsiomSel[EZI2C_SDA_PIN_INDEX] = EZI2C_SDA_HSIOM_SEL_SPI;
        #endif /* (EZI2C_SDA_PIN) */
            ...
            {
                /* Slave */
                pinsDm[EZI2C_SCL_PIN_INDEX] = EZI2C_PIN_DM_DIG_HIZ;
                pinsDm[EZI2C_SDA_PIN_INDEX] = EZI2C_PIN_DM_STRONG;
                ...
                /* Disable input buffer */
                 pinsInBuf |= EZI2C_SDA_PIN_MASK;
            #endif /* (EZI2C_SDA_PIN) */
            }
            else 
            {
                /* (Master) */
                pinsDm[EZI2C_SCL_PIN_INDEX] = EZI2C_PIN_DM_STRONG;
                pinsDm[EZI2C_SDA_PIN_INDEX] = EZI2C_PIN_DM_DIG_HIZ;
        ...
        else /* UART */
        {
            if (EZI2C_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (EZI2C_SDA_PIN)
                hsiomSel[EZI2C_SDA_PIN_INDEX] = EZI2C_SDA_HSIOM_SEL_UART;
                pinsDm  [EZI2C_SDA_PIN_INDEX] = EZI2C_PIN_DM_OD_LO;
            #endif /* (EZI2C_SDA_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (EZI2C_SCL_PIN)
                    hsiomSel[EZI2C_SCL_PIN_INDEX] = EZI2C_SCL_HSIOM_SEL_UART;
                    pinsDm  [EZI2C_SCL_PIN_INDEX] = EZI2C_PIN_DM_DIG_HIZ;
                #elif (EZI2C_RX_WAKE_SDA_MOSI_PIN)
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        EZI2C_SET_HSIOM_SEL(EZI2C_SCL_HSIOM_REG,
                                       ...
                                       EZI2C_SCL_HSIOM_POS,
                                        hsiomSel[EZI2C_SCL_PIN_INDEX]);

        EZI2C_i2c_scl_SetDriveMode((uint8) pinsDm[EZI2C_SCL_PIN_INDEX]);

        #if (!EZI2C_CY_SCBIP_V1)
            EZI2C_SET_INP_DIS(EZI2C_i2c_scl_INP_DIS,
                                         EZI2C_i2c_scl_MASK,
                                         (0u != (pinsInBuf & EZI2C_SCL_PIN_MASK)));
        #endif /* (!EZI2C_CY_SCBIP_V1) */
    ...
    #if (EZI2C_SDA_PIN)
        EZI2C_SET_HSIOM_SEL(EZI2C_SDA_HSIOM_REG,
                                       EZI2C_SDA_HSIOM_MASK,
                                       EZI2C_SDA_HSIOM_POS,
                                        hsiomSel[EZI2C_SDA_PIN_INDEX]);

        EZI2C_i2c_sda_SetDriveMode((uint8) pinsDm[EZI2C_SDA_PIN_INDEX]);

    #if (!EZI2C_CY_SCBIP_V1)
        EZI2C_SET_INP_DIS(EZI2C_i2c_sda_INP_DIS,
                                     EZI2C_i2c_sda_MASK,
                                    (0u != (pinsInBuf & EZI2C_SDA_PIN_MASK)));
    #endif /* (!EZI2C_CY_SCBIP_V1) */
    #endif /* (EZI2C_SCL_PIN) */
