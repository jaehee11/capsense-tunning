...
#if (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO)
	extern CapSense_CSD_CONFIG_TYPE_P4_v2_20 CapSense_CSD_config;
#endif  /* (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO) */
...
uint8 CapSense_CSD_negativeNoiseThreshold[] = {
    10u, 10u, 10u, 
};
...
void CapSense_CSD_UpdateBaselineNoThreshold(uint32 sensor)
{
	...
	#if (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO)
	    MeasureNoiseEnvelope_P4_v2_20(&CapSense_CSD_config, (uint8)sensor, CapSense_CSD_sensorRaw);
	#endif /* (CapSense_CSD_TUNING_METHOD == CapSense_CSD__TUNING_AUTO) */
