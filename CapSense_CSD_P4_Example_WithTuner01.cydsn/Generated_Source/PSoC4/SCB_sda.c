...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        SCB_sda_PC =   (SCB_sda_PC & \
                                (uint32)(~(uint32)(SCB_sda_DRIVE_MODE_IND_MASK << (SCB_sda_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (SCB_sda_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  SCB_sda_DM_STRONG     Strong Drive 
*  SCB_sda_DM_OD_HI      Open Drain, Drives High 
*  SCB_sda_DM_OD_LO      Open Drain, Drives Low 
*  SCB_sda_DM_RES_UP     Resistive Pull Up 
*  SCB_sda_DM_RES_DWN    Resistive Pull Down 
*  SCB_sda_DM_RES_UPDWN  Resistive Pull Up/Down 
*  SCB_sda_DM_DIG_HIZ    High Impedance Digital 
*  SCB_sda_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(SCB_sda__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro SCB_sda_ReadPS calls this function. 
*  
*******************************************************************************/
